...
SYSTEM = function() {
  ...
  var Parent = function(childQuant, radius, xPos, yPos) {
    ...
    this.shapeCoords = [
      ...
      //year
      //year
      [-84, 105], [-75, 105], [-65, 105], [-35, 105], [-25, 105], [-15, 105], [25, 105], [45,105],[55,105],[65,105],[75, 105], [85, 105],
      [-95, 115], [-55, 115], [-45, 115], [-5, 115], [15, 115], [25, 115], [80, 115],
      [-95, 125], [-55, 125], [-45, 125], [-15, 125], [-5, 125], [25, 125], [75, 125],
      [-65, 135], [-45, 135], [-25, 135], [-5, 135], [25, 135], [70,135], [80,135], [90,135],[60,135], [50,135],
      [-75, 145], [-45, 145], [-35, 145], [-5, 145], [25, 145], [65,145],
      [-85, 155], [-45, 155], [-5, 155], [25, 155], [60,155],
      [-95, 165], [-85, 165], [-75, 165], [-65, 165], [-55, 165], [-35, 165], [-25, 165], [-15, 165], [15, 165], [25, 165], [35, 165], [55,165],
      //treee
      [-140,-80],                                                                [-140, 20],
      [-140,-60],                                                                [-140, 40],
      [-100, -80], [-100, -60], [-100, -40], [-100, -20], [-100, 0], [-100, 20], [-100, 40],
      [-120, -80], [-120, -60], [-120, -40], [-120, -20], [-120, 0], [-120, 20], [-120, 40], 
      [-80, -80],                                                                [-80, 20],
      [-80, -60],                                                                [-80, 40],


      [-50, -80], [-50, -60], [-50, -40], [-50, -20], [-50, 0], [-50, 20], [-50, 40],
      [-30, -80], [-30, -60], [-30, -40], [-30, -20], [-30, 0], [-30, 20], [-30, 40], 
      [-10, -80], [10, -80], [30, -80],         
      [-10, -60], [10, -60], [30, -60],
      [-10, 40], [10, 40], [30, 40],
      [-10, 20], [10, 20], [30, 20],

      [60, -80], [60, -60], [60, -40], [60, -20], [60, 0], [60, 20], [60, 40],
      [80, -80], [80, -60], [80, -40], [80, -20], [80, 0], [80, 20], [80, 40],
      [100, -80], [100, -60],                              [100, 20], [100,40],
      [120, -80], [120, -60],                              [120, 20], [120,40],
      [140, -80], [140, -60], [140, -40], [140, -20], [140, 0], [140, 20], [140, 40],
      [160, -80], [160, -60], [160, -40], [160, -20], [160, 0], [160, 20], [160, 40],  
    ...
    this.drawChildren = function() {
      ...
      for(var i = this.children.length - 1; i >= 0; i -= 1) {
        if(i === shapes) {
          color = ParentParticle.isActive ? '#33b5e5' : 'rgb(190,190,190)';
          ...
          color = ParentParticle.isActive ? '#33b5e5' : 'rgb(190,190,190)';
        } else if(i < shapes - 48 && i > shapes - 82) {
          color = ParentParticle.isActive ? '#33b5e5' : 'rgb(190,190,190)';
        } else if(i < shapes - 82){
          color = ParentParticle.isActive ? '#33b5e5' : 'rgb(190,190,190)';
    ...
    this.drawDistance = function(x1, y1, x2, y2, color, minDist) {
      ...
      if(dist <= minimDist) {
        ...
        if(ParentParticle.isActive && color) {
          ...
          ctx.strokeStyle = "rgba(100, 100, 100,"+ (2.2 - dist / this.minDist) +")";
        }
  ...
  var ParentParticle = new Parent(150, 200, cnv.width / 2, cnv.height / 2);
  ParentParticle.born();
