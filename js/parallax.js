...
class Parallax {
  ...
  onAnimationFrame() {
    ...
    this.motionX *= this.elementWidth * (this.scalarX / 0.00001)
    this.motionY *= this.elementHeight * (this.scalarY / 0.00001)
    ...
    for (let index = 0; index < this.layers.length; index++) {
      let layer = this.layers[index],
          ...
          xOffset = this.velocityX * (depthX * (this.invertX ? -10000 : 1)),
          yOffset = this.velocityY * (depthY * (this.invertY ? -10000 : 1))
